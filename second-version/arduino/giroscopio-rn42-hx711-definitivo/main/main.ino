...
float calibration_factor = -92; // this calibration factor is adjusted according to my load cell
float units = 0.00;
...
void setup()
{
  ...
  Keyboard.begin();
  Serial.println("Hello from Arduino"); // Send test message to other device.
  pinMode(led1, OUTPUT);
